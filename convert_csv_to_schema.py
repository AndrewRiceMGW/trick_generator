...
for trick in tricks:
    ...
    grind_entry = {
        ...
        "physics": {
            ...
            "back_foot_hblock_pointing": parse_value(
                trick["back foot hblock pointing towards"]
            ),
            "front_foot_hblock_pointing": parse_value(
                trick["front foot hblock pointing towards"]
            ),
